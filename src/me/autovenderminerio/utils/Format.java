package me.autovenderminerio.utils;
...
public class Format {
    ...
    private static BoxAutoVenderMinerio main = BoxAutoVenderMinerio.getPlugin(BoxAutoVenderMinerio.class);
    ...
    public static double parseString(String value) throws Exception {
        ...
        if (!matcher.find()) {
            throw new Exception("§b[BoxPesca] §cEsse formato não existe.");
